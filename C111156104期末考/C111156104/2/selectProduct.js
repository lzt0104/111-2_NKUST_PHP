...
function showBuyStagePage(productName, productPrice) {
  ...
  document.getElementById("productNumber").onchange = function() {
    buyEvent()
  }
  document.getElementById("cal").onclick = function(){
      let data = {
        ...
        "num" : document.getElementById("productNumber").value,
        "addr" : document.getElementById("addr").value
    }
    axios.post("http://localhost/C111156104/2/buy.php",Qs.stringify(data)) //大小寫要注意^^
    .then(res =>{
